...
- **Achievements** — milestone tracker for liquid net worth ($1M–$10M), FIRE milestones (Coast FIRE uses the configured retirement age), bridge-fund checkpoints from 1 to 20 years using inflation-adjusted withdrawals and scenario growth, and home equity, with compact category cards, calculation explanations, progress bars, and estimated completion dates

...
def verify():
    ...
    with sync_playwright() as p:
        ...
        check(page.locator(".achievement-explainer").count() == 4, "achievement explanations stay compact")
        ...
        check(page.evaluate("DATA.retirement_profile.target_age === 42 && DATA.retirement_profile.birth_year === 1995 && DATA.retirement_profile.birth_month === 9 && DATA.retirement_profile.retirement_access_age === 59.5"), "retirement profile is embedded")
        ...
        check(page.locator("text=Bridge to age 59½").count() >= 1, "bridge includes retirement access target")
